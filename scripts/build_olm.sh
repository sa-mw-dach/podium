...
sudo opm index add -c docker --bundles quay.io/podium/podium-operator-catalog:1.0.2 --bundles quay.io/podium/podium-operator-catalog:1.0.3 --bundles quay.io/podium/podium-operator-catalog:1.0.4 --bundles quay.io/podium/podium-operator-catalog:1.0.5 --bundles quay.io/podium/podium-operator-catalog:$VERSION --tag quay.io/podium/podium-operator-index:$VERSION
if [ $? != 0 ]; then exit 1; fi
